          ...
          for (const row of jsonData) {
            try {
              ...
              const customer: Partial<Customer> = {
                ...
                contactPerson: row.contactPerson || row.contact || row.contact_person || row.Contact || '',
                ...
                customerType: mapCustomerType(row.customerType || row.customer_type || row.type || ''),
                ...
                tags: mapTags(row.tags || row.Tags || ''),
                isReturningCustomer: Boolean(row.isReturningCustomer || row.returning || false),
                valueTier: mapValueTier(row.valueTier || row.value_tier || ''),
                directImport: mapDirectImport(row.directImport || row.direct_import || ''),
                lastFollowUpDate: row.lastFollowUpDate || row.last_follow_up || '',
                nextFollowUpDate: row.nextFollowUpDate || row.next_follow_up || '',
                lastContactNotes: row.lastContactNotes || row.last_contact_notes || '',
                keyMeetingPoints: row.keyMeetingPoints || row.key_meeting_points || '',
                isHotLead: Boolean(row.isHotLead || row.hot_lead || false),
                isPinned: Boolean(row.isPinned || row.pinned || false),
              };
